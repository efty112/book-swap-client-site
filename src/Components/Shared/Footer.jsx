    ...
    return (
        <div>
            <footer className="footer bg-neutral gap-0 text-neutral-content">
                ...
                <div className='w-full h-full bg-[#100d28] p-16 flex justify-center'>
                    <p className="text-center space-y-5">
            ...
            <div className="footer footer-center bg-[#050deb] opacity-60 text-white p-4">
                <aside>
                    <p>Copyright © 2024 - All right reserved by Book Swap</p>
                </aside>
            </div>
        </div>
    );
